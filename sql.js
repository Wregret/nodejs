...
var sql = {
    ...
    getReceiptsByUsername: 'SELECT Name AS productName, count(*) AS quantity FROM products, orders, receipts, WHERE orders.Username LIKE ? AND orders.OrderId = receipts.OrderId AND receipts.ASIN = products.ASIN GROUP BY receipts.ASIN',
